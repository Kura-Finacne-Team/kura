...
export default function AboutPage() {
  return (
    <div className="w-full h-auto bg-[#0B0B0F] text-white">
      {/* Background Ambient Glows */}
      <div className="fixed top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#8B5CF6]/10 blur-[120px] rounded-full pointer-events-none z-0" />
      <div className="fixed bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-[#3B82F6]/10 blur-[120px] rounded-full pointer-events-none z-0" />

      {/* Breadcrumb / Back button */}
      <div className="sticky top-0 px-6 py-3 border-b border-white/5 bg-[#0B0B0F]/95 backdrop-blur-md z-20">
        <Link
          href="/"
      ...
      {/* Main content */}
      <main className="relative z-10 w-full px-4 sm:px-6 py-16">
        <div className="w-full max-w-5xl mx-auto">
          ...
          <section className="mb-24">
            <div className="rounded-3xl border border-[#8B5CF6]/20 bg-gradient-to-br from-[#1A1A24]/80 to-[#0B0B0F]/80 backdrop-blur-xl p-8 sm:p-10 relative overflow-hidden flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="hidden md:flex w-32 h-32 rounded-full border border-white/10 items-center justify-center bg-white/5 backdrop-blur-sm relative z-10">
          ...
          <section className="mb-24">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[
                ...
                <div key={index} className="rounded-xl border border-white/5 bg-white/[0.01] hover:bg-white/[0.03] hover:border-white/10 transition-all duration-300 p-6 group">
          ...
          {/* Footer Info */}
          <footer className="pt-10 pb-6 text-center text-gray-600 text-sm font-mono flex flex-col sm:flex-row justify-between items-center border-t border-white/5">
